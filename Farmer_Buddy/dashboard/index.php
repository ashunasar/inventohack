			...
			<div class="main-panel">
				...
				<div class="content-wrapper">
                 ...
                 <?php include "includes/middle.php" ?>
							...
							<div class="row">
								<div class="col-lg-4 d-flex grid-margin stretch-card">
									<div class="card sale-visit-statistics-border">
										<div class="card-body">
																       <!--calculation for since started date-->
                    <?php 
                    $today =strtotime(date("y-m-d"));
                    $start_date_in_date_format = $start_date;
                    $start_date =strtotime($start_date);
                    $seconds = $today - $start_date;

                    $final_day = floor($seconds / (24*60*60));
                    if($final_day == 0){
                    ?>
                    <h2 class="text-dark mb-2 font-weight-bold">Today</h2>
                    <h4 class="card-title mb-2">Since Stared</h4>
                    <small class="text-muted"><?php echo $start_date_in_date_format?></small>
                    <?php
                    }
                    else if($final_day == 1){
                    ?>

                    <h2 class="text-dark mb-2 font-weight-bold"><?php echo $final_day?> day</h2>
                    <h4 class="card-title mb-2">Since Stared</h4>
                    <small class="text-muted"><?php echo $start_date_in_date_format?></small>
                    ...
                    <h2 class="text-dark mb-2 font-weight-bold"><?php echo $final_day?> days</h2>
                    <h4 class="card-title mb-2">Since Stared</h4>
                    <small class="text-muted"><?php echo $start_date_in_date_format?></small>
                    ...
                    ?>
								...
								<div class="col-lg-4 d-flex grid-margin stretch-card">
									<div class="card sale-diffrence-border">
										<div class="card-body">
											<h2 class="text-dark mb-2 font-weight-bold"><?php echo $test_conducted?></h2>
											<h4 class="card-title mb-2">Total Test Conducted</h4>
											<small class="text-muted"><?php //echo $test_conducted?></small>
										</div>
									</div>
								</div>
								<div class="col-lg-4 d-flex grid-margin stretch-card">
									<div class="card sale-visit-statistics-border">
										<div class="card-body">
											<h2 class="text-dark mb-2 font-weight-bold"><?php echo $current_stage?></h2>
											<h4 class="card-title mb-2">Current Stage</h4>
<!--											<small class="text-muted">JANUARY 2020</small>-->
                    ...
                    <a class="nav-link pl-2 pr-2" id="sales-by-traffic-tab" data-toggle="tab" href="#npk" role="tab" aria-controls="sales-by-traffic" aria-selected="false">NPK</a>
                            ...
                            <iframe src="../charts/temp.php" frameborder="0" height="350px" width="100%"></iframe>
                            </div>
                            <div class="tab-pane fade" id="humidity" role="tabpanel" aria-labelledby="server-loading-tab">
                            <iframe src="../charts/humidity.php" frameborder="0" height="350px" width="100%"></iframe>
                            </div>
                            <div class="tab-pane fade" id="SoilMoisture" role="tabpanel" aria-labelledby="data-managed-tab">
                            <iframe src="../charts/soil_moisture.php" frameborder="0" height="350px" width="100%"></iframe>
                            </div>

                            <div class="tab-pane fade" id="Hydrogen" role="tabpanel" aria-labelledby="data-managed-tab">
                            <iframe src="../charts/hydrogen.php" frameborder="0" height="350px" width="100%"></iframe>
                            </div>
                            <div class="tab-pane fade" id="CarbonMonoxide" role="tabpanel" aria-labelledby="data-managed-tab">
                            <iframe src="../charts/carbon_monoxide.php" frameborder="0" height="350px" width="100%"></iframe>
                            </div>
                            <div class="tab-pane fade" id="npk" role="tabpanel" aria-labelledby="data-managed-tab">
                            <iframe src="../charts/npk.php" frameborder="0" height="350px" width="100%"></iframe>
                            </div>
...
<!--													<p class="text-dark">Monday 3.00 PM</p>-->
													<div class="d-lg-flex align-items-baseline mb-3">
														<h1 class="text-dark font-weight-bold">21<sup class="font-weight-light"><small>o</small><small class="font-weight-medium">c</small></sup></h1>
