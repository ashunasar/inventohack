          ...
          <div class="row w-100 mx-0">
            <div class="col-lg-4 mx-auto">
              ...
              <div class="auth-form-light text-left py-5 px-4 px-sm-5">
                ...
                <form class="pt-3" method="post" action="login.php" enctype="multipart/form-data">
...
<!--                    <a href="#" class="auth-link text-black">Forgot password?</a>-->
                ...
                <div class="text-center mt-4 font-weight-light">
                Are You an Admin? <a href="admin.php" class="text-primary">Admin Login</a>
                </div>
  ...
  <?php      
            ...
            $query_result = mysqli_query($con, $query);
             ...
             while($row = mysqli_fetch_assoc($query_result)){
                ...
                $farmers_pass    = $row['farmers_pass'];
                //$farmers_pass    = $row['farmers_proof'];
            }
        
            if($mobile_number ==$farmers_mobile &&  $password ==$farmers_pass){
            $_SESSION['farmers_mobile'] = $farmers_mobile;  
             //$_SESSION['farmers_mobile'] = "SDFSDFSDF";
            ?>
